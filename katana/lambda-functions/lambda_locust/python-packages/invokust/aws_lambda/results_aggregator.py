...
def results_aggregator(results):
    ...
    for task in request_tasks:
        ...
        print('========================================TASK DATA RESULTS=====================================================')
        print(task_data_results)
        print('===========================================================================================================================')
        ...
        agg_results['requests'][task]['response_time_percentiles'] = task_data_results[0]['response_time_percentiles']
        agg_results['requests'][task]['api'] = task
