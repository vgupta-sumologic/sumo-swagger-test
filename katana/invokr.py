...
SumoHttpLog = 'https://nite-events.sumologic.net/receiver/v1/http/ZaVnC4dhaV3HghVIbXDx3RshPCWKJVLG528uN--NigUTVwXT2ubmKxLST22I0lLRrtXm8xUqXYK2_mbjTTV3xgbmWiPtcpndzVMCMwrjlez9spyT2LzIJQ=='
...
def print_stats_exit(load_test_state):
    ...
    logging.info(
        '===========================================================================================================================')
    r = requests.post(SumoHttpLog, data=json.dumps(agg_results))

    logging.info("Sending performance data to sumo endpoint... "+str(r.status_code) +  r.reason)
